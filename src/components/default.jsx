    ...
    <Carousel fade>
      <Carousel.Item>
        <img
          ...
          src={CarouselImage1}
          alt="Sunglasses at sunset by Ari He on Unsplash"
        />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src={CarouselImage2}
          alt="Sunglasses in sand by Ethan Robertson on Unsplash"
        />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src={CarouselImage3}
          alt="Italian seaside reflection in sunglasses by Joshua Kettle on Unsplash"
        />
        <Carousel.Caption>
